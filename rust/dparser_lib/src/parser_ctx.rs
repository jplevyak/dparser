...
use crate::types::{PNode, SNode, ZNode, Reduction, Shift};
...
impl ParserContext {
    pub fn new(input_len: usize, input_base: *const std::os::raw::c_char, tables: *const crate::bindings::D_ParserTables) -> Self {
        Self {
            string_start: 0,
