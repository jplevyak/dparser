...
#
#
# Copyright (c) 2006-2007 <christian.montanari@sharp.eu>, Sharp-Telecommunication of Europe Ltd. . All rights reserved.
...
use base qw(Exporter Class::Container Convert::ASN1);
...
default ASN1 white space function also detecting comments.
