...
ArgumentDescription arg_desc[] = {
    {"longest_match",
     'l',
     "Use Longest Match Rule for Tokens",
     "T",
     &longest_match,
     "D_MAKE_LONGEST_MATCH",
     NULL},
    {"tokenizer",
     'T',
     "Tokenizer for START",
     "T",
     &tokenizer,
     "D_MAKE_PARSER_TOKENIZER",
     NULL},
    {"whitespace_states",
     'C',
     "Compute Whitespace States",
     "T",
     &states_for_whitespace,
     "D_MAKE_PARSER_WHITESPACE",
     NULL},
    {"all_states",
     'A',
     "Compute States For All NTERMs",
     "T",
     &states_for_all_nterms,
     "D_MAKE_PARSER_ALL_NTERMS",
     NULL},
    {"scanner_blocks",
     'b',
     "Scanner Blocks",
    ...
    {"right_recurse_BNF",
     'r',
     "Use Right Recursion For */+",
     "T",
     &right_recursive_BNF,
     "D_MAKE_PARSER_RIGHT_RECURSIVE_BNF",
     NULL},
    ...
    {"commit_interval",
     ...
     "D_PARSE_COMMIT_INTERVAL",
     NULL},
    {"fixup",
     'f',
     "Fixup Internal Productions",
     "T",
     &fixup,
     "D_PARSE_FIXUP",
     NULL},
    ...
    {"noheight",
     'H',
     "Do not use Height Disambiguization",
     "T",
     &no_height_disamb,
     "D_PARSE_NO_HEIGHT_DISAMB",
     NULL},
    {"nogreedy",
     'G',
     "Do not use Greedy Disambiguization",
     "T",
     &no_greedy_disamb,
     "D_PARSE_NO_GREEDY_DISAMB",
     NULL},
