# the 'nodes' argument to actions is useful for obtaining line number
...
def d_start(t, nodes, this):
    'start : noun verb'
    del t
    # in this example, nodes[0] is the D_ParseNode for 'noun'

    # the 'buf' member contains the entire string that is being parsed
    buf = nodes[0].buf
    noun = nodes[0]

    # the 'end', 'end_skip', and 'start_loc.s' members of nodes[0] are indices
