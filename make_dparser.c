...
static ArgumentDescription arg_desc[] = {
    ...
    {"write_header", 'H', "Write Header (-1:if not empty)", "I", &write_header, "D_MAKE_PARSER_HEADER", NULL},
    {"token_type", 't', "Token Type (0:define, 1:enum)", "I", &token_type, "D_MAKE_PARSER_TOKEN", NULL},
    ...
    {"grammar_ident", 'i', "Grammar Identifier", "S255", grammar_ident, "D_MAKE_PARSER_GRAMMAR_IDENT", NULL},
