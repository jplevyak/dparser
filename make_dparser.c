...
static ArgumentDescription arg_desc[] = {
    ...
    {"filename_ident",
     ...
     "T",
     &ident_from_filename,
     "D_MAKE_PARSER_IDENT_FROM_FILENAME",
     NULL},
    {"scanner_blocks",
     'b',
     "Scanner Blocks",
    ...
    {"ext",
     'X',
     "Code file extension (e.g. cpp)",
     "S256",
     &write_extension[0],
     "D_MAKE_PARSER_WRITE_EXT",
     NULL},
    {"verbose",
     'v',
     "Verbose",
    ...
    {"rdebug_grammar",
     'R',
     "Replace actions with ones printing productions",
     "+",
...
int main(int argc, char* argv[])
{
    ...
    if (!output_file[0])
    {
        ...
        strncat(output_file,
                ".d_parser.",
                sizeof(output_file) - strlen(output_file) - 1);
        strncat(output_file,
                g->write_extension,
                sizeof(output_file) - strlen(output_file) - 1);
    }
